package com.beauscott.mobile.skins
{
    ...
    public class CalloutSkin extends MobileSkin
    {
        ...
        protected var backgroundFill:SpriteVisualElement;
        
        protected var dropShadow:RectangularDropShadow;
        ...
        protected var highlightWeight:Number;
        ...
        {
            return (hostComponent is Callout) && (arrow && arrow.parent) && ((hostComponent.arrowDirection == ArrowDirection.LEFT
        ...
        {
            return (hostComponent is Callout) && (arrow && arrow.parent) && ((hostComponent.arrowDirection == ArrowDirection.UP
