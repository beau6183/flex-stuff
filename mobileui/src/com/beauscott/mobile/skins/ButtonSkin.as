package com.beauscott.mobile.skins
{
    ...
    [Style(name="chromeBrightness", type="number", format="Number", inherit="yes")]
    [Style(name="chromeRatios", type="Array", arrayType="Number", inherit="yes")]
    [Style(name="chromeAlphas", type="Array", arrayType="Number", inherit="yes")]
    [Style(name="highlightRotation", type="number", format="Number", inherit="yes")]
    [Style(name="borderVisible", type="Boolean", format="Boolean", inherit="no")]
    /**
    ...
    public class ButtonSkin extends ButtonSkinBase
    {
        ...
        {   
            ...
            if (!_border || (!borderClass || !(_border is borderClass)))
                changeFXGSkin = true;
        ...
        override protected function drawBackground(unscaledWidth:Number, unscaledHeight:Number):void
        {
            ...
            {
                var colors:Array = [];
                var brightness:Number = getStyle('chromeBrightness') === undefined ? 70 : getStyle('chromeBrightness');
...
//                trace("Chrome rotation", rotation, "brightness", brightness);
                ...
                colors[0] = ColorUtil.adjustBrightness2(chromeColor, brightness);
                colors[1] = chromeColor;
                var chromeAlphas:Array = getStyle("chromeAlphas") === undefined ? CHROME_COLOR_ALPHAS : getStyle("chromeAlphas");
                var chromeRatios:Array = getStyle("chromeRatios") === undefined ? CHROME_COLOR_RATIOS : getStyle("chromeRatios");
